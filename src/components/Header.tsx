...
const Header = ({ score, moves }: { score: number; moves: number }) => {
  ...
  return (
    <header className="flex justify-between items-center p-4 bg-background text-secondary font-retro w-4/5 m-auto border-2 border-accent-100 rounded-3xl ">
   
      <h1 className="text-xl font-retro">Memory Game</h1>
